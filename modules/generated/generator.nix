{
  ...
  in
    builtins.any (part: shouldIgnore part) parts;

  # Filter list of files and removes ignored files that have prefix in any part of their path
  # [ str ] -> [ str ]
  filterIgnoredFiles = files: builtins.filter (file: !shouldIgnoreFile file) files;
  ...
  filterEnabledIfDefault = attrset:
    ...
    then attrset
      ...
      (
        ...
        else lib.attrsets.mapAttrs (_n: v: filterEnabledIfDefault v) attrset
      );
