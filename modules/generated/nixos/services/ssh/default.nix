{lib, ...}: let
  sshKeys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILd9xMsdC7C9gpbOZBXzeQ9TzHPiZScV1TWxnFn6hxA5 martin@xps-wsl"
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOvst8b/ykA1sSP9FM1BtRxJIw+ZT0LLHaLIw67Ao3ET devnull@Martins-MacBook-Air.local"
  ];
in {
  services.openssh = {
    enable = true;
